...
from angle_utils import calculate_arm_height, Collision_prevention, Collision_prevention_with_table
import time
...
b = Collision_prevention(margin=16, a_deg=a, b_deg=b)
#b = Collision_prevention_with_table(a_deg=a, b_deg=b)  # テーブルとの衝突防止
